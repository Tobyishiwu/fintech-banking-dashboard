...
export default function Register() {
  ...
  const handleRegister = (e) => {
    ...
    // Temporary Frontend-only registration mock
    setSuccess("Account pre-created successfully! Redirecting to login...");
    
    // Simulate API network delay, then push them to login page
    setTimeout(() => {
      navigate("/login");
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-[#070B1A] text-white flex flex-col justify-center items-center p-4 selection:bg-blue-500/30">
      <div className="w-full max-w-md bg-[#0F172A] border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl space-y-6">
        ...
        {success && (
          <div className="p-3 bg-green-500/10 border border-green-500/20 text-green-400 rounded-xl text-xs font-medium text-center">
            {success}
          </div>
        )}
